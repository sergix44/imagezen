...
trait DefaultAlterations
{
    ...
    {
        $this->register(
            Alterations\Blur::class,
            Alterations\HeavyBlur::class,
            Alterations\Brightness::class,
            Alterations\EllipseShape::class,
            Alterations\CircleShape::class,
            Alterations\Colorize::class,
            Alterations\Contrast::class,
            Getters\GetWidth::class,
            Getters\GetHeight::class,
            Alterations\Crop::class,
            Getters\GetExif::class,
            Getters\GetFilesize::class,
            Alterations\Fill::class,
            Alterations\Fit::class,
            Alterations\Flip::class,
            Alterations\Gamma::class,
            Alterations\GreyScale::class,
            Alterations\Heighten::class,
            Alterations\Insert::class,
            Alterations\Interlace::class,
            Alterations\Invert::class,
            Getters\GetIptc::class,
            Alterations\LimitColors::class,
            Alterations\LineShape::class,
            Alterations\Mask::class,
            Getters\GetMime::class,
            Alterations\Opacity::class,
            Alterations\Orientate::class,
            Getters\GetColor::class,
            Alterations\Pixel::class,
            Alterations\Pixelate::class,
            Alterations\PolygonShape::class,
            Alterations\RectangleShape::class,
            Alterations\Resize::class,
            Alterations\ResizeCanvas::class,
            Alterations\Rotate::class,
            Alterations\Sharpen::class,
